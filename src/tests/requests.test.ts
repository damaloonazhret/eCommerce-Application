...
describe('getSearchProducts', () => {
    it('should return an empty results array when no products match the search parameters', async () => {
        ...
        const result = await getSearchProducts(anonymousToken, paramSearch, 0, 'sort=name.en-us asc');
    ...
    it('should correctly handle sorting by price, popularity, and other product attributes', async () => {
        ...
        global.fetch = jest.fn().mockResolvedValue(mockResponse);
        await getSearchProducts(anonymousToken, paramSearch, 0, 'sort=name.en-us asc');
        ...
        await getSearchProducts(anonymousToken, paramSearch2, 0, 'sort=name.en-us asc');
        ...
        await getSearchProducts(anonymousToken, paramSearch3, 0, 'sort=name.en-us asc');
